...
void max_heap_insert(List *list, int length, int value)
{
    ...
    list = (List *)realloc(list, length);

    (list + length)->data = (Node *)malloc(sizeof(Node));
    (list + length)->data->x = value;
    ...
    // insert the new node in to the end of the list
    // reposision the new node in the heap
}
...
int main()
{
    ...
    // max_heap_insert(list, *rcount, 53000);
